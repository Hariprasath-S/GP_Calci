       ...
       $.ajax({                                      
        ...
        $.ajax({                                      
          ...
          success: function(data){
            ...
            var eg = data[5]==0?'-':data[5];
            var eeelab = data[6]==0?'-':data[6];
        ...
        $.ajax({                                 
          ...
          success: function(data){
            ...
            var dsalab = data[5]==0?'-':data[5];
            var dsa = data[6]==0?'-':data[6];
            var oops = data[7]==0?'-':data[7];
            var ese = data[8]==0?'-':data[8];
            var dldlab = data[9]==0?'-':data[9];
        ...
        $.ajax({                                      
          ...
          success: function(data){
            ...
            var oslab = data[5]==0?'-':data[5];
            var ict = data[6]==0?'-':data[6];
            var os = data[7]==0?'-':data[7];
            var coi = data[8]==0?'-':data[8];
            var ddmlab = data[9]==0?'-':data[9];
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide slide1" style="postion: relative">
                        ...
                        <div class="row  m-1 mb-2 p-3 justify-content-center align-items-center">
                            ...
                            <div class="col-6 text-right" id="eng">
                            </div>
                        </div>
